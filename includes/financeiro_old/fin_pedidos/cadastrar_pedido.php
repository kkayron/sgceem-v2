...
try {
    ...
    $sql = "INSERT INTO fin_pedidos_forn (
        id_os, batalhao, cmt_ceem, ch_controle, ch_suprimento, local_pedido, solicitante, secao_rspns, situacao_pedido, data_pedido, id_vtr, desconto_empenho
    ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    // LOG
    // ============================
    registrar_log($conexao, $usuario_id, 'Cadastrar pedido', "Novo pedido cadastrado: ID $id_pedido");
