...
<div class="modal fade" id="modalCadastrarRequisicao" tabindex="-1" aria-labelledby="modalLabelCadastrarRequisicao" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-success text-white">
        <h5 class="modal-title" id="modalLabelCadastrarRequisicao">Cadastrar Requisição</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
      </div>
      <div class="modal-body">
        <form method="POST" enctype="multipart/form-data" id="form-requisicao-cadastrar">
<div class="mb-3">
    <label class="form-label fw-semibold">Batalhão</label>
    <select id="cadastrar-batalhao" name="batalhao" class="form-select">
        ...
        <?php endforeach; ?>
          ...
          <div class="mb-3">
            <label class="form-label">Requisitante</label>
            <input type="text" class="form-control" id="cadastrar-requisitante" name="requisitante" required>
          </div>
            
            <div class="mb-3">
            <label class="form-label">Natureza da despesa</label>
            <input type="text" class="form-control" id="cadastrar-naturezadespesa" name="naturezadespesa" required>
          </div>
            
            <div class="mb-3">
            <label class="form-label">Item OOG</label>
            <input type="text" class="form-control" id="cadastrar-item_oog" name="item_oog" required>
          </div>
            
            <div class="mb-3">
            <label class="form-label">Finalidade da requisição</label>
            <input type="text" class="form-control" id="cadastrar-finalidade" name="finalidade" required>
          </div>

          <div class="mb-3">
            <label class="form-label">Destinatário</label>
            <input type="text" class="form-control" id="cadastrar-destinatario" name="destinatario" required>
          </div>

          <div class="mb-3">
            <label class="form-label">Nota Crédito</label>
            <input type="text" class="form-control" id="cadastrar-nota_credito" name="nota_credito" required>
          </div>

          <div class="mb-3">
            <label class="form-label">Plano Interno</label>
            <input type="text" class="form-control" id="cadastrar-plano_interno" name="plano_interno" required>
          </div>
            
            
            <div class="mb-3">
    <label for="status" class="form-label">Necessidade de contrato?</label>
    <select class="form-select rounded-pill shadow-sm" id="cadastrar-necessidade_contrato" name="necessidade_contrato" required>
      <option value="Sim">Sim</option>
      <option value="Não">Não</option>
    </select>
  </div>
            ...
            <div class="mb-3">
    <label for="status" class="form-label">Tipo de empenho</label>
    <select class="form-select rounded-pill shadow-sm" id="cadastrar-tipo_empenho" name="tipo_empenho" required>
      <option value="Global">Global</option>
      <option value="Ordinário">Ordinário</option>
    </select>
  </div>
          ...
          <div class="mb-3">
    <label for="status" class="form-label">Status da Requisição</label>
    <select class="form-select rounded-pill shadow-sm" id="cadastrar-status_requisicao" name="status_requisicao" required>
      <option value="Em confecção">Em confecção</option>
      <option value="Entregue na S4">Entregue na S4</option>
      <option value="Entregue na Fisc Adm">Entregue na Fisc Adm</option>
      <option value="Entregue na SALC">Entregue na SALC</option>
      <option value="Empenho gerado">Empenho gerado</option>
          ...
          <div id="itensRequisicaoContainerCadastrar" style="display: none;">
            ...
            <div id="itensRequisicaoListaCadastrar"></div>
          </div>
...
<script>
    ...
    $('#modalCadastrarRequisicao').on('shown.bs.modal', function () {
    window.inicializarRequisicaoCadastrar();
});
