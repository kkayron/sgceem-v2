...
<div class="container">
  <div class="page-inner">
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
      <div>
        <h3 class="fw-bold mb-3">Relatório da Manutenção Preventiva</h3>
        <h6 class="op-7 mb-2">Sistema de Gerenciamento da Cia E Eqp Mnt</h6>
      </div>
    </div>

    <!-- PLACEHOLDERS -->
 <div id="dashPreventiva" class="mb-4">
      <div class="card shadow-sm">
        <div class="card-body text-muted">
          <i class="fas fa-spinner fa-spin me-2"></i>Carregando manutenção preventiva...
        </div>
      </div>
    </div>
...
(function(){
  const map = {
      preventiva: { container: 'dashPreventiva', url: 'includes/dashboard/bloco_preventiva.php' },
  };
